...
import EditNoteModal from "@/components/note/modal/edit-note-modal";
import DeleteNoteModal from "@/components/note/modal/delete-note-modal";
import ArchiveNoteModal from "@/components/note/modal/archive-note-modal";
import RestoreNoteModal from "@/components/note/modal/restore-note-modal";
          ...
          <div className="text-sm font-medium text-foreground flex-1">
            ...
            {isExpanded ? (
              <ScrollArea className="h-[200px] w-full rounded-md border p-3">
                <div className="relative w-full wrap-break-word whitespace-pre-wrap [&_pre]:break-normal [&_pre]:whitespace-pre [&_pre]:overflow-x-auto">
              ...
              // collapsed view
              <div
                className={`relative w-full wrap-break-word whitespace-pre-wrap [&_pre]:break-normal [&_pre]:whitespace-pre [&_pre]:overflow-x-auto ${
